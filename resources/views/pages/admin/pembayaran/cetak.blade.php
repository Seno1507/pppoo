...
<head>
   <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>BUKTI CETAK PEMBAYARAN SPP SMKIU {{ strtoupper($pembayaran->siswa->nama) }} {{ date('d M Y') }}</title>
...
<body>
   ...
   <div class="size2 text-center mb-1">BUKTI CETAK PEMBAYARAN SPP SMKIU</div>
